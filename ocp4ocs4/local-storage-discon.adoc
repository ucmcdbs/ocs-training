...
image::OCS4-OperatorHub-Subscribe.png[OCP OperatorHub Subscribe]
...
----
NAME                         DISPLAY                       VERSION        REPLACES   PHASE
ocs-operator.v4.4.0-415.ci   OpenShift Container Storage   4.4.0-415.ci              Succeeded
----
...
image::OCP4-installed-operators-rc.png[Openshift showing the installed operators in namespace openshift-storage]
